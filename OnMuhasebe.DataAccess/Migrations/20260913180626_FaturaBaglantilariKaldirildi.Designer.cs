...
namespace OnMuhasebe.DataAccess.Migrations
{
    ...
    [Migration("20260913180626_FaturaBaglantilariKaldirildi")]
    partial class FaturaBaglantilariKaldirildi
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnMuhasebe.Entities.Tables.FaturaSatir", b =>
                {
                    ...
                    b.ToTable("FaturaSatirlari", null, t =>
                        {
            ...
            modelBuilder.Entity("OnMuhasebe.Entities.Tables.StokHareket", b =>
                {
                    ...
                    b.HasIndex("StokId", "Tarih");

                    b.ToTable("StokHareketleri", null, t =>
                        {
                            t.HasCheckConstraint("CK_StokHareketleri_Miktar", "[HareketTipi] = 'Sayim' OR [Miktar] > 0");
                        });
                });
